...
}},_unbindScrollResize:function(){if(this._scrollResizeHandle){this._scrollResizeHandle.detach();delete this._scrollResizeHandle;}}},true);g.Base.mix(g.DataTable,[b]);},"3.6.0pr3",{skinnable:true,requires:["datatable-base","dom-screen"]});