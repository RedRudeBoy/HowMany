...
export default Ember.ArrayController.extend({
	actions: {
		resetData: function() {
			...
			*/
			Ember.Logger.log('Starting...');

			var store = this.get('store');

//			var calendar = store.createRecord('vcalendar',
//				{"prodid":"-//RedRudeBoy//HowMany//EN","version":"2.0","x-wr-calname":"Example Calendar","x-wr-caldesc":"Personal agenda example","x-wr-timezone":null}
//			);
			var calendar = store.push('vcalendar',
				{id: 1,"prodid":"-//RedRudeBoy//HowMany//EN","version":"2.0","x-wr-calname":"Example Calendar","x-wr-caldesc":"Personal agenda example","x-wr-timezone":null}
			);
			Ember.Logger.log('calendar pushed...');
			//ToDos
			var todo1 = store.push('vtodo',
				{id: 1,"categories":"house,journey","location":"home","description":"Cada setmana el dilluns, dimecres, divendres, fins: 22 set. 2015","status":"TENTATIVE","summary":"Visitar la familia","created":"2014-08-07T18:26:14.265Z","last-modified":"2014-08-07T18:26:14.265Z","sequence":1,"percent_complete":null,"rrule":"FREQ=WEEKLY;UNTIL=20150921T000000Z;BYDAY=MO,WE,FR","parent_vcalendar":calendar}
			);
			var todo2 = store.push('vtodo',
				{id: 2,"categories":"house","location":"home","description":"Un altre todo","status":"TENTATIVE","summary":"L'onze d'agost del 2014","created":"2014-08-11T18:26:34.427Z","last-modified":"2014-08-11T18:26:34.427Z","sequence":1,"percent_complete":null,"parent_vcalendar":calendar}
			);
			var todo3 = store.push('vtodo',
				{id: 3,"categories":"house","location":"home","description":"Més todos","status":"TENTATIVE","summary":"to_do_3s","created":"2014-08-11T18:26:34.427Z","last-modified":"2014-08-11T18:26:34.427Z","sequence":1,"percent_complete":null,"parent_vcalendar":calendar}
			);
			Ember.Logger.log('calendar save...');
			calendar.save().then(function() {
				Ember.Logger.log('vtodo save...');
				var promises = Ember.A();
				promises.push(todo1.save());
				promises.push(todo2.save());
				promises.push(todo3.save());
				Ember.RSVP.Promise.all(promises).then(function(resolvedPromises){
					Ember.Logger.log('Finish!');
				});
			});
		}
	}
